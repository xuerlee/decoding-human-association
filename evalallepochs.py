...
def get_args_parser():
    ...
    parser.add_argument('--set_cost_action_class', default=0, type=float,
    ...
    parser.add_argument('--groupsize_loss_coef', default=5, type=float)
    ...
    parser.add_argument('--resume',
                        ...
                        default='output_dir/restartall_hidden256_enc6dec6_12queries_lossratio223_jrdbgroup_kinetics_remvoccsevoccnoevalnone_ioufiltered_11act_sampleequal_CyclicLR_TransQ_noscalenorm_001entropy_grpbcesizecost_bcesizeloss_rmvNaN_optgroupingonly_lr1e-4_sizelossratio5',
