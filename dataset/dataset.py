...
def build(args):
    ...
    # elif args.feature_file == 'volleyball':
        # train_img_file, train_ann_file, test_img_file, test_ann_file = volleyball_path(img_root, ann_root)
        #
        # train_anns = volleyball_read_dataset(train_ann_file)  # ann dictionary
        # train_frames = volleyball_all_frames(train_anns, num_frames)  # frame and sec ids: (s, f)
        # # print(train_frames)
        #
        # test_anns = volleyball_read_dataset(test_ann_file)
